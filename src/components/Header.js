    ...
    return (
        <section className='shadow-md'>
            ...
            <div className='flex justify-center items-center text-xl gap-2 font-medium text-slate-900'>
                ...
                <span className='first-letter:text-2xl text-xl cursor-pointer' onClick={()=> navigate('/')}>Abdullah's Catering</span>
            </div>
            ...
            basis-full md:basis-auto py-2 md:py-0">
                ...
                <button 
                className='px-3 py-1.5 rounded-full text-base text-gray-900/90 bg-white font-medium
