        ...
        <div className='min-h-[calc(100vh-166.5px)] flex justify-center items-center px-3'>
            <form className='max-w-sm mx-auto p-5 rounded-xl shadow-[0_0_15px_1px_rgba(0,0,0,0.343)] w-full'>
                ...
                <p className='font-medium mb-5 ml-2 flex items-center gap-2'>
                    <CubeIcon className='text-gray-900 h-6'/>Create New Account. 
                ...
                <div className='flex justify-center items-center gap-5'>
                    <button className="py-1.5 rounded-md shadow-[0_0_15px_1px_rgba(0,0,0,0.343)] text-gray-900/80 hover:text-gray-900 border-0 font-medium duration-150 active:scale-95 ">
