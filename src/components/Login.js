...
const Login = () => {
    ...
    const resetPass = async ()=> {
        ...
        if (valid) {
            ...
            toast('password reset link was sent');
        } else {
    ...
    return (
        <div className='min-h-[90vh] flex justify-center items-center px-3'>
            ...
            <form ref={inputField} className='max-w-sm mx-auto p-5 rounded-xl shadow-[0_0_15px_1px_rgba(0,0,0,0.343)] w-full fromLeft'>
                ...
                <p className='font-medium ml-2 flex items-center gap-2'>
                    <span
                    onClick={resetPass}
                    className='text-sky-700 underline decoration-[3px] underline-offset-2 hover:scale-110 duration-150 cursor-pointer active:scale-95'>Forget password</span>
                </p>
                <div className='flex justify-center items-center gap-5 mt-5'>
                    ...
                    <button 
                    onClick={login}
                    className="px-10 py-1.5 rounded-md text-sky-700 font-medium text-lg
